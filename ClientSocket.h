...
public:
    WSAInitHandler(int verMajor = 2, int verMinor = 2)
    {
        ...
        {
            //version number too high, recoverable error, retry using the highest available.
...
class ClientSocket : public BaseWindow<ClientSocket,NullTraits>
{
    SOCKET m_socket;
    UINT MSG_SOCKET;
...
public:
    ...
    : m_socket(INVALID_SOCKET), MSG_SOCKET(::RegisterWindowMessage(TEXT("ClientSocket 1.0"))),
